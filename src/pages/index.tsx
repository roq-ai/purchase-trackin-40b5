  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless digital song purchase tracking with Purchase Tracking. Add, view, and filter purchases by song name, version, platform, units, and date. Master data management for platforms and songs included."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Experience seamless digital song purchase tracking with Purchase Tracking. Add, view, and filter purchases by song name, version, platform, units, and date. Master data management for platforms and songs included.`}
            </Text>
